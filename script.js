...
var beel = new Audio("./audio/audio_bell.mp3")
...
function momentoAcao (){
    ...
    if(sessoes_valor != '1'){
        document.getElementById('title_sessoes').innerHTML = sessoes_valor + ' sessões restantes ' 
    } else{
        document.getElementById('title_sessoes').innerHTML = sessoes_valor + ' sessão restante '
    }
